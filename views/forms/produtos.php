                            ...
                            <div class="modal-dialog">
                                ...
                                <form>
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="nomepro"  placeholder="Nome do produto">
                                    </div>
                                    <div class="form-group">
                                      <label for="Quantidadeproduto">Quantidade</label>
                                      <input type="number" class="form-control" min="1" id="quantidadepro" placeholder="Quantidade de produtos">
                                    </div>
                                    <div class="form-group">
                                      <label for="Valorprodutos">Valor</label>
                                      <input type="text" min="1" max="100" step="0.01" class="form-control" id="valorpro"  placeholder="0,00">
                                    </div>
