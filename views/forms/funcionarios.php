                    ...
                    <div class="row">
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    ...
                                    <!--    FORMULÁRIO DO MODAL FUNCIONÁRIO-->
                                <form>
                                    <div class="form-group">
                                      <label for="Nomefuncionario">Nome</label>
                                      <input type="text" class="form-control" id="nomefun"  placeholder="Nome completo">
                                    </div>
                                    <div class="form-group">
                                      <label for="Emailfuncionario">Email</label>
                                      <input type="email" class="form-control" id="emailfun" placeholder="exemplo@exemplo.com">
                                    </div>
                                    <div class="form-group">
